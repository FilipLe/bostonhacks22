...
def main():
  if functions.check_data():
    ...
    feels_like_afternoon = data["feels_like_afternoon"]
...
In the afternoon, it will feel like {feels_like_afternoon} Celsius. \
At night, it will feel like {feels_like_night} Celsius. \
...
Please don't forget to put on a {arr_clothes[0]} and {arr_clothes[1]}!"
        ...
        functions.email_alert("Dear Bob",
                              f"\n{message1} {message2}\nEnjoy your day!",
